...
function pageField() {
  ...
  if (tab === 'Overview') {
    body = `<div class="grid g2">
      ...
      <div class="card">
        <h4 style="margin-bottom:10px;">Your match breakdown</h4>
        ${hasGuidanceData()
          ...
          `<div style="margin-bottom:10px;"><div style="display:flex;justify-content:space-between;font-size:13px;"><span>${l}</span>${matchPct(v)}</div>
          ...
          : `<p style="color:var(--muted);font-size:13.5px;">Complete your academic profile and questionnaire to see a match breakdown.</p>
